...
if("TRUE" STREQUAL "TRUE")
  set(mavconn_SOURCE_PREFIX /home/hoang/Desktop/auv_ws/src/VIAM_AUV/src/mavconn)
  set(mavconn_DEVEL_PREFIX /home/hoang/Desktop/auv_ws/devel)
  set(mavconn_INSTALL_PREFIX "")
  set(mavconn_PREFIX ${mavconn_DEVEL_PREFIX})
else()
  set(mavconn_SOURCE_PREFIX "")
  set(mavconn_DEVEL_PREFIX "")
  set(mavconn_INSTALL_PREFIX /home/hoang/Desktop/auv_ws/install)
...
if(NOT "/home/hoang/Desktop/auv_ws/src/VIAM_AUV/src/mavconn/include " STREQUAL " ")
  set(mavconn_INCLUDE_DIRS "")
  set(_include_dirs "/home/hoang/Desktop/auv_ws/src/VIAM_AUV/src/mavconn/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mavconn' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hoang/Desktop/auv_ws/src/VIAM_AUV/src/mavconn/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(mavconn_EXPORTED_TARGETS ${${mavconn_dep}_EXPORTED_TARGETS})
endforeach()
