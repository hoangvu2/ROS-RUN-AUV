...
(cl:defclass <MassShifterStatus> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass MassShifterStatus (<MassShifterStatus>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MassShifterStatus>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MassShifterStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name utils-msg:<MassShifterStatus> is deprecated: use utils-msg:MassShifterStatus instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MassShifterStatus>))
...
(cl:defmethod position-val ((m <MassShifterStatus>))
...
(cl:defmethod motor_duty-val ((m <MassShifterStatus>))
...
(cl:defmethod motor_temp_on_chip-val ((m <MassShifterStatus>))
...
(cl:defmethod motor_temp_ambient-val ((m <MassShifterStatus>))
...
(cl:defmethod motor_current-val ((m <MassShifterStatus>))
...
(cl:defmethod motor_rspeed-val ((m <MassShifterStatus>))
...
(cl:defmethod motor_dspeed-val ((m <MassShifterStatus>))
  ...
  (motor_dspeed m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <MassShifterStatus>) ostream)
  "Serializes a message object of type '<MassShifterStatus>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MassShifterStatus>) istream)
  "Deserializes a message object of type '<MassShifterStatus>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MassShifterStatus>)))
  "Returns string type for a message object of type '<MassShifterStatus>"
  "utils/MassShifterStatus")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MassShifterStatus)))
  "Returns string type for a message object of type 'MassShifterStatus"
  "utils/MassShifterStatus")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MassShifterStatus>)))
  "Returns md5sum for a message object of type '<MassShifterStatus>"
  "4d19354ecb4d6d7947c5f5f62d9bdce2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MassShifterStatus)))
  "Returns md5sum for a message object of type 'MassShifterStatus"
  "4d19354ecb4d6d7947c5f5f62d9bdce2")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MassShifterStatus>)))
  "Returns full string definition for message of type '<MassShifterStatus>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MassShifterStatus)))
  "Returns full string definition for message of type 'MassShifterStatus"
  (cl:format cl:nil "Header header~%~%float64 position~%float64 motor_duty~%float64 motor_temp_on_chip~%float64 motor_temp_ambient~%float64 motor_current~%float64 motor_rspeed~%float64 motor_dspeed~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <MassShifterStatus>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <MassShifterStatus>))
  "Converts a ROS message object to a list"
  (cl:list 'MassShifterStatus
