...
class SetModeResponse(genpy.Message):
  _md5sum = "df91e327dd911b56636abb9e5811e464"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2B().pack(_x.mode_sent, _x.success))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mode_sent, _x.success,) = _get_struct_2B().unpack(str[start:end])
...
class SetMode(object):
  _type          = 'utils/SetMode'
  _md5sum = '9e4b9ba1103ec8afb0a70ef718b9243e'
